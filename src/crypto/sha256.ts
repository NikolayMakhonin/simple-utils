export function sha256(data: Uint8Array): string {
  ...
  const bits = n * 8
  view.setUint32(newLen - 4, bits, false)
  if (bits > 0xffffffff) {
    view.setUint32(newLen - 8, Math.floor(bits / 0x100000000), false)
  }
  ...
  return Array.from([h0, h1, h2, h3, h4, h5, h6, h7])
